...
#pragma warning(disable:4996) //la till denna för att _CRT_SECURE_NO_WARNINGS inte ville fungera av någon anledning
#ifndef LIST_H
#define LIST_H
...
struct node
{
    int occurances; //EXAMINATION, förekomster av ett data i den länkade listan.
    Data data;
    struct node *next;
};
