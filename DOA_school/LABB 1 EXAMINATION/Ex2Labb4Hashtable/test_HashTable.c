...
#include "HashTable-6.h" // EXAMINATION, la på -6 i alla c och h filer som behövde det istället för att byta namn på alla filer.
...
/*Klistra in denna funktion i din testfil och gör ett anrop till funktionen från main*/
void testFunctionExamination(void)
{
    ...
    //lägg till några personer och kontrollera att de ligger pa rätt plats
    for (i = 0; i < 9; i++)
    {
    ...
    //Lägg till en till så att tabellen blir full
    strcpy(aPerson.name, "Viktor");
    aPerson.personalNumber = 930317;
    aPerson.weight = 70.1;
    insertElement(&htable, 930317, aPerson);
    assert(htable.table[0].key == 900610);
    assert(htable.table[1].key == 881011);
    assert(htable.table[2].key == 740318);
    assert(htable.table[3].key == 830709);
    ...
    assert(htable.table[5].key == 600704);
    assert(htable.table[6].key == 801204);
    assert(htable.table[7].key == 930317);
    assert(htable.table[8].key == 790408);
    assert(htable.table[9].key == 510929);

    //Lägg till en trots att tabellen är stor ==> ny storlek
    strcpy(aPerson.name, "Greta");
    aPerson.personalNumber = 320702;
    aPerson.weight = 58.7;
    insertElement(&htable, 320702, aPerson);
    //Ange att ny storlek är 7 - programmet ska be om en ny storlek
    //Ange att ny storlek är 15
    assert(htable.table[0].key == 510929);
    assert(htable.table[1].key == 881011);
    assert(htable.table[2].key == 930317);
    assert(htable.table[3].key == 320702);
    assert(htable.table[4].key == UNUSED);
    assert(htable.table[5].key == UNUSED);
    assert(htable.table[6].key == UNUSED);
    assert(htable.table[7].key == UNUSED);
    assert(htable.table[8].key == 740318);
    assert(htable.table[9].key == 830709);
    assert(htable.table[10].key == 900610);
    assert(htable.table[11].key == 931014);
    assert(htable.table[12].key == 801204);
    assert(htable.table[13].key == 790408);
    assert(htable.table[14].key == 600704);

    //Ta bort en person som inte har några efterföljande
    deleteElement(&htable, 320702);
    assert(lookup(&htable, 320702) == NULL);
    assert(htable.table[3].key == UNUSED);

    //Ta bort en person som har efterföljande
    deleteElement(&htable, 830709);
    assert(lookup(&htable, 830709) == NULL);
    assert(htable.table[0].key == 510929);
    assert(htable.table[1].key == 881011);
    assert(htable.table[2].key == 930317);
    assert(htable.table[3].key == UNUSED);
    ...
    assert(htable.table[7].key == UNUSED);
    assert(htable.table[8].key == 740318);
    assert(htable.table[9].key == 931014);
    assert(htable.table[10].key == 900610);
    assert(htable.table[11].key == 801204);
    ...
    deleteElement(&htable, 600704);
    for (int i = 0; i < 15; i++)
        assert(htable.table[i].key == UNUSED);
    ...
    printf("Congratulations! Your hashtable passed the test\n\n");
}
